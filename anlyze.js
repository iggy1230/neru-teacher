// --- anlyze.js (完全版 v119.0: 画面遷移完全修復版) ---
...
window.selectMode = function(m) {
    ...
    try {
        ...
        if (typeof switchScreen === 'function') {
            ...
            console.error("switchScreen is missing");
            alert("画面切り替えエラーだにゃ。リロードしてみてにゃ。");
            return;
        }
