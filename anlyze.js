// --- anlyze.js (完全版 v16.3: 変数定義修正・全機能統合) ---
...
async function startLiveChat() {
    ...
    try {
        ...
        nextStartTime = audioContext.currentTime; // ★追加：ここがUndefinedだとエラーになる
    ...
    try {
        ...
        workletNode.port.onmessage = (event) => {
            ...
            setTimeout(() => {
                ...
                liveSocket.send(base64Audio); // 生Base64
            }, 250);
        };
