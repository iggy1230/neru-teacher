...
function startConversation() {
    ...
    if (typeof window.initAudioContext === 'function') window.initAudioContext();
    ...
    recognition.onerror = (event) => {
        ...
        stopChatMode();
        updateNellMessage("うまく聞こえなかったにゃ……", "thinking");
    };
