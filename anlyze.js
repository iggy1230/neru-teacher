// --- anlyze.js (完全版 v33.0: 不死身の音声認識 & ログ送信強化) ---
...
let isRecognitionActive = false; // 認識を続けるかどうかのフラグ
            ...
            recognition.onresult = (event) => {
                for (let i = event.resultIndex; i < event.results.length; ++i) {
                    if (event.results[i].isFinal) {
                        ...
                        console.log("🎤 認識した言葉:", transcript); // ブラウザコンソールで確認用
...
// ... (他関数は変更なしのため省略、元のコードを維持) ...
// setAnalyzeMode, setSubject, giveLunch, showGame, fetchGameComment, initGame, movePaddle, touchPaddle, drawGame, endGame, handleFileUpload, resizeImageForDetect, initCustomCropper, updateCropUI, performPerspectiveCrop, startAnalysis, camIn/albIn, startHint, showNextHint, revealAnswer, renderProblemSelection, renderMistakeSelection
