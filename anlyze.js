...
// 2. ★Live Chat (Web Audio API & WebSocket)
...
async function giveLunch() {
    ...
    try {
        ...
        updateNellMessage(replyText, data.isSpecial ? "excited" : "happy");
