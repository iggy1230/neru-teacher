    ...
    setInterval(() => {
        ...
        if (window.isNellSpeaking) {
            ...
            if (toggle) img.src = talkIcon;
                ...
                if (currentSubject && subjectImages[currentSubject] && currentMode !== 'chat' && currentMode !== 'lunch') img.src = subjectImages[currentSubject];
                else img.src = defaultIcon;
            }
        } else {
