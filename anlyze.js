// --- anlyze.js (修正版: ハートアニメーション & ボタン非表示徹底) ---
...
// --- ★修正: ハートアニメーション (Web Animations API) ---
    ...
    if(heartCont) { 
        for(let i=0; i<8; i++) { 
            ...
            heart.animate([
                ...
                { transform: 'scale(1) translateY(-20px)', opacity: 1, offset: 0.2 },
