...
function startMouthAnimation() {
    ...
    setInterval(() => {
        ...
        // (チャットや給食モードでは必ず通常服)
        const isSubjectMode = (currentMode === 'explain' || currentMode === 'grade' || currentMode === 'review');
        
        if (isSubjectMode && currentSubject && subjectImages[currentSubject]) {
        ...
        // ※フルパスURLが含まれる場合があるため、endsWithで判定
