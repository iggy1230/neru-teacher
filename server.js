// --- server.js (完全版 v73.0: 給食・ヒントシステム強化) ---
    ...
    try {
        ...
        const rules = {
            ...
            'こくご': {
                ...
                hints: `
                  ・漢字問題の場合 ヒント1: 「漢字のなりたち」を教える
                  ・漢字問題の場合 ヒント2: 「辺やつくりや画数」を教える
                  ・漢字問題の場合 ヒント3: 「似た漢字」を教える
                  ・読解問題の場合 ヒント1（場所）: 「答えがどこにあるか」を教える（例：2ページ目の3行目あたりを読んでみてにゃ）。
                  ・読解問題の場合 ヒント2（キーワード）: 「注目すべき言葉」を教える（例：『しかし』のあとの文章が大事だにゃ）。
                  ・読解問題の場合 ヒント3（答え方）: 「語尾の指定」など（例：『〜ということ』で終わるように書くにゃ）。`,
                grading: `
                  ・送り仮名が間違っている場合はバツだにゃ。
