// --- analyze.js (完全版 v244.0: 確実なターン管理版) ---
...
window.captureAndSendLiveImage = function() {
    ...
    // ★重要変更: 画像送信後、サーバー側で確実に「ターン完了(turn_complete)」と認識される形式で指示を送る
    setTimeout(() => {
...
function stopLiveChat() { 
    ...
    if (recognitionWatchdogTimer) clearInterval(recognitionWatchdogTimer); // 番犬停止
